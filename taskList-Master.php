...
$account_sid = getenv("MASTER_ACCOUNT_SID");
$auth_token = getenv('MASTER_AUTH_TOKEN');
$client = new Client($account_sid, $auth_token);
$workspaceSid = getenv("MASTER_WORKSPACE_SID");
...
foreach ($tasks as $task) {
    echo "+ Task SID: " . $task->sid . "\xA";;
    echo "++ Task attributes: " . $task->attributes . "\xA";;
    $i++;
